  ...
  return (
    <div className="p-8 max-w-3xl">
      ...
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold text-slate-900 mb-1">Create Schedule</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          {scheduleType === 'one_off' ? (
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 space-y-4">
              ...
              <p className="text-xs text-slate-500">Tip: set the same start and end date for a single-day schedule.</p>
            </div>
          ) : (
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 space-y-4">
              <div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 space-y-4">
            ...
            <label className="flex flex-col items-center justify-center w-full py-8 border-2 border-dashed border-slate-300 rounded-xl cursor-pointer bg-slate-50 hover:bg-slate-100 transition">
              <div className="text-3xl mb-2">📎</div>
              <p className="text-sm font-medium text-slate-700">Click to choose files</p>
              <p className="text-xs text-slate-500 mt-1">You can select multiple files</p>
              <input
                type="file"
                multiple
