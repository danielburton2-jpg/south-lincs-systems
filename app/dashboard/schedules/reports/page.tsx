  ...
  return (
    <div className="p-8 max-w-6xl">
      ...
      <div className="mb-6 no-print">
        ...
        <h1 className="text-2xl font-bold text-slate-900 mb-1">Schedules Reports</h1>
      ...
      {/* Print-only header */}
      <div className="print-only px-6 py-4 border-b border-slate-300">
        <h1 className="text-2xl font-bold text-slate-900">{company?.name}</h1>
        <p className="text-sm text-slate-700">Schedule Report</p>
      ...
      <div className="space-y-4">
        ...
        <div className="flex justify-between items-center flex-wrap gap-3 no-print">
          <div>
            <h2 className="text-xl font-semibold text-slate-800">Completed Schedules</h2>
          ...
          <div className="flex gap-2 flex-wrap">
            ...
            <button
              onClick={exportPDF}
              disabled={filtered.length === 0}
              className="bg-red-600 hover:bg-red-700 disabled:bg-slate-300 disabled:cursor-not-allowed text-white px-4 py-2 rounded-lg text-sm font-medium"
            >
              ⬇ PDF
            </button>
            <button
              onClick={handlePrint}
              disabled={filtered.length === 0}
              className="bg-gray-700 hover:bg-gray-800 disabled:bg-slate-300 disabled:cursor-not-allowed text-white px-4 py-2 rounded-lg text-sm font-medium"
            >
              🖨 Print
            </button>
          </div>
        ...
        {/* FILTERS */}
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-4 space-y-3 no-print">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
            ...
            <div>
              <label className="block text-xs font-medium text-slate-600 mb-1">Completion Type</label>
              <select
        ...
        {filtered.length === 0 ? (
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                        ...
                        {s.schedule_type === 'recurring' && (
                          <div className="flex gap-1 flex-wrap">
                            {getRecurringDayPills(s.recurring_days).map(d => (
                              <span key={d} className="text-xs bg-slate-100 text-slate-700 px-1.5 py-0.5 rounded">
                                {d}
                              </span>
                            ))}
                          </div>
            ...
            <div className="md:hidden divide-y divide-slate-100 no-print">
              {filtered.map(s => (
                <div
                  key={s.id}
                  onClick={() => router.push(`/dashboard/schedules/${s.id}`)}
                ...
                >
                  ...
                  <div className="flex flex-wrap gap-x-4 gap-y-1 text-xs text-slate-600 ml-7">
