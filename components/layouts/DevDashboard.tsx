    ...
    <div className="dev-layout">
      ...
      <div className="dev-content">
        ...
        {page === "create-superuser" && (
          <CreateSuperuser close={()=>setPage("dashboard")} />
        )}

        {/* VIEW SUPERUSERS */}
        {page === "view-superusers" && !editUser && (
          <ViewSuperusers openEdit={setEditUser} />
        )}
        ...
        {/* CREATE COMPANY */}
        {page === "create-company" && (
          <CreateCompany close={()=>setPage("view-companies")} />
        )}

        {/* VIEW COMPANIES LIST */}
        {page === "view-companies" && !selectedCompany && (
          <ViewCompanies openCompany={setSelectedCompany} />
        )}
